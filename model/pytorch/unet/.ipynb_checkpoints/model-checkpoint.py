...
class Unet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.attention4 = AttentionGate(512, 512) # 512 512
        self.decoder4 = DecoderBlock(512, 256, 0.2) # 512 512
        
        self.attention3 = AttentionGate(256, 256) # 256 256  
        self.decoder3 = DecoderBlock(256, 128, 0.2)  # 256 256
