...
class Dataset(object):
    ...
    def __init__(self, annot_path, input_size, batch_size,  classes, anchors, anchor_per_scale, strides, data_aug: bool, is_training: bool, dataset_type: str = "converted_coco"):
    ...
    def preprocess_true_boxes(self, bboxes):
        ...
        bboxes_xywh = [np.zeros((self.max_bbox_per_scale, 4)) for _ in range(feature_size)]
