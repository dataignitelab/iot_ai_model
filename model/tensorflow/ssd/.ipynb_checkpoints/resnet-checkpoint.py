...
def create_resnet18_layers():
    ...
    layer2 = keras.Model(x, out)
    
    x = keras.Input(shape=(None, None, 128))
    out = make_layer(x, 256, blocks_per_layer[2], stride=2, name='layer3')
    layer3 = keras.Model(x, out)
    
#     x = keras.Input(shape=(None, None, 256))
#     out = make_layer(x, 512, blocks_per_layer[3], stride=2, name='layer4')
#     layer4 = keras.Model(x, out)
    
#     x = keras.Input(shape=(None, None, 512))
#     out = make_layer(x, 1024, 1,  stride=1, name='layer4')
    
#     layer5 = keras.Model(x, out)
