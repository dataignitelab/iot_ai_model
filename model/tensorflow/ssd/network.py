...
from resnet import create_resnet18_layers
...
class SSD(Model):
    ...
    def __init__(self, num_classes, arch='ssd300',  model='resnet18'):
        super(SSD, self).__init__()
        self.num_classes = num_classes
        self.model = model
        
        if(self.model == 'resnet18'):
            # self.resnet_layer2, self.resnet_layer3, self.resnet_layer4, self.resnet_layer5 = create_resnet18_layers()
            self.resnet_layer2, self.resnet_layer3= create_resnet18_layers()
        else:
